...
architecture arch_imp of isPrime_v1_0 is

	-- component declaration
	component isPrime_v1_0_S00_AXIS is
		generic (
	...
	end component isPrime_v1_0_S00_AXIS;

	component isPrime_v1_0_M00_AXIS is
		generic (
        ...
        isPrimeOut : in std_logic_vector(C_M_AXIS_TDATA_WIDTH-1 downto 0);
	...
	end component isPrime_v1_0_M00_AXIS;
    
    
    signal s_dataValid    : std_logic;
    signal s_isPrimeOut   : std_logic_vector(C_M00_AXIS_TDATA_WIDTH-1 downto 0);
...
isPrime_v1_0_S00_AXIS_inst : isPrime_v1_0_S00_AXIS
	generic map (
		C_S_AXIS_TDATA_WIDTH	=> C_S00_AXIS_TDATA_WIDTH
	)
	port map (
	    dataValid => s_dataValid,
        isPrimeOut => s_isPrimeOut,
...
isPrime_v1_0_M00_AXIS_inst : isPrime_v1_0_M00_AXIS
	generic map (
