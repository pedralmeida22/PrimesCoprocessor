...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {256.577} \
   CONFIG.CLKOUT1_PHASE_ERROR {297.890} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {62.000} \
  ...
  # Create instance: isPrime_0, and set properties
  set isPrime_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:isPrime:1.0 isPrime_0 ]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins isPrime_0/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net isPrime_0_M00_AXIS [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins isPrime_0/M00_AXIS]
