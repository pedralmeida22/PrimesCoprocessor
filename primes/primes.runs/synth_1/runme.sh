...
HD_PWD='C:/Users/pedra/Documents/PrimeNumbers/primes/primes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log isPrime_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source isPrime_tb.tcl
